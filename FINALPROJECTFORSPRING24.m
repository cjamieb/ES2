...
fluvaccineindex = find(healthyagingMA.Topic=="Influenza vaccine within past year");
...
fluvaccineMA = healthyagingMA(fluvaccineindex, :);
...
fluvaccinefind65 = fluvaccineMA((find(fluvaccineMA.Stratification1=="65 years or older")), :);
fluvaccinefind65(1, :) = []
fluvaccinefind65(5, :) = []
fluvaccinefindoverall = fluvaccineMA((find(fluvaccineMA.Stratification1=="Overall")), :);
fluvaccinefindoverall(2, :) = []
fluvaccinefind50 = fluvaccineMA((find(fluvaccineMA.Stratification1=="50-64 years")), :);
fluvaccinefind50(1, :) = []
fluvaccinefind50(1, :) = []
