...
% from https://blogs.mathworks.com/loren/2011/01/13/data-driven-fitting/
% think this one is needed for bootstrapping, but not otherwise
...
ys1 = smooth(x1,y1,span,'rlowess'); % 'loess', 'lowess', 'rloess', or 'rlowess'
